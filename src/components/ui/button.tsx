  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        sage: "bg-sage text-primary-foreground hover:bg-sage/90 shadow-soft hover:shadow-glow",
        terracotta: "bg-terracotta text-accent-foreground hover:bg-terracotta/90 shadow-soft",
        soft: "bg-sage-light text-sage hover:bg-sage/10 border border-sage/20",
        mood: "bg-secondary hover:bg-secondary/80 border-2 border-transparent hover:border-primary/20 transition-all",
        floating: "bg-card shadow-floating hover:shadow-lg border border-border/50 hover:border-primary/30",
      },
      size: {
